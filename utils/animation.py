...
fig, [ax1, ax2] = plt.subplots(nrows=1, ncols=2, figsize=(13.33, 7.5), dpi=96, gridspec_kw={'width_ratios': [1, 1.5]})
...
ax3.set_title(r'Standard deviation in $\frac{E_{T}}{E_{U}}$ for $\bar{\rho}=0.05$', y=1.05)
...
#ani = animation.FuncAnimation(fig, animate_points, frames=no_frames, interval=100)
#
